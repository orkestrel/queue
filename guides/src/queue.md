...
> one (or all) parked loops, so an idle queue burns zero CPU. Cancellation is built on the L1 [abort](abort.md)
>
...
| `isQueueTimeout`     | function | Total guard for the native timer range, inclusive.                |
